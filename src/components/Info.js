    ...
    <div className="info-container">
      <div className='info-wrapper'>
        ...
        <p className='description-paragraph'>
          <span className="name-highlight font-info-header">Ethereum</span><span className="custom-header font-info-header">trading algoirthm.</span>
        </p>
        ...
        <p className='description-paragraph font-paragraph'>
          Being a Long Bot, this script performs best in general uptrends, but nonetheless proves efficient enough to run autonomously across many cycles. It is shown here operating full-time over a <span className='highlight'>5</span> year period, from the ETH/USDT launch on Binance in August of 2017, through June of 2022, the time of publishing this script.<br/>
        ...
        <p className='description-paragraph font-paragraph'>
          ...
          Statistics in the Performance Summary show how this strategy plays out in the trade metrics. Specifically, winning trades are almost <span className='highlight'>2</span> times larger than losing trades, on average, and they also last for an average of <span className='highlight'>5</span> days, whereas losing trades usually last about 2.
        </p>
        <p className='description-paragraph font-paragraph'>
